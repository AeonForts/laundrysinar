        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label class="fo~rm-label">Nama Paket</label>
                        <textarea name="nama_paket" class="form-control @error('nama_paket') is-invalid @enderror" required>{{old('nama_paket')}}</textarea>
